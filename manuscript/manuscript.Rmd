---
title: "A Comparison of Machine Learning Models for Water Quality Forecasting"
authors:
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_historical_oxygen.png}
    \caption{}
  \end{subfigure}
  
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_naive_oxygen.png}
    \caption{}
  \end{subfigure}
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_historical_temperature.png}
    \caption{}
  \end{subfigure}
  
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_naive_temperature.png}
    \caption{}
  \end{subfigure}
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_historical_chla.png}
    \caption{}
  \end{subfigure}
  
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_naive_chla.png}
    \caption{}
  \end{subfigure}
...
\begin{figure}[!htbp]
  ...
  \caption{Comparison of Historical and Naive parameters intra}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/global_loc_historical_oxygen.png}
    \caption{}
  \end{subfigure}
  
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../plots/date_type_global_historical_oxygen.png}
    \caption{}
  \end{subfigure}
